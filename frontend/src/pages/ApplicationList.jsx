...
const ApprovalList = () => {
    ...
    const fetchApprovals = async () => {
        try {
            const response = await axios.get('http://localhost:4000/vriddhi/pending-approvals', { withCredentials: true });
    ...
    const onApprove = async (studentId) => {
        try {
            ...
            await axios.post("http://localhost:4000/vriddhi/approveStudent", { studentId });
    ...
    const onReject = async (studentId) => {
        try {
            ...
            await axios.post("http://localhost:4000/vriddhi/rejectStudent", { studentId });
